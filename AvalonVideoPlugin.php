...
*/
    ...
    public function hookPublicAvalonVideo($args)
    {
        $this->append($args);
?>
	  <script>jQuery(document).ready(function() {jQuery('#exhibit-content').find('h1').after(jQuery('#avalon_player'));});
	</script>
<?php
    }
    ...
    { ?>
      	<?php if ($avalonUrl = metadata('item',array('Avalon Video','Avalon Section PURL'))) {
...
?>
			<div id="avalon_player" style= "margin:0 auto;">
				...
				<iframe style="margin:0 auto;" src="//<?php echo $avalon_host;?>/master_files/avalon:<?php echo $avalon_id;?>/embed" width=<?php echo metadata('item',array('Avalon Video','Avalon Width'));?> height=<?php echo metadata('item',array('Avalon Video','Avalon Height'));?> frameborder=0 webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			</div>
			<?php } else { ?>
					<iframe style="margin:0 auto;" src="//<?php echo $avalon_host;?>/master_files/avalon:<?php echo $avalon_id;?>/embed" width=<?php echo get_option('avalon_width_public');?>; height=<?php echo get_option('avalon_height_public');?>; frameborder=0 webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
				</div>
		<?php	}  
			} 
	 } 
